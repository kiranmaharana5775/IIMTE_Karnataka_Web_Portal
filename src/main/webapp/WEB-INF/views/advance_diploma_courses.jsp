                ...
                <div class="table-container">
                    <table>
                        ...
                        <tbody>
                            <tr>
                                <td>1</td>
                                <td style="text-align: left; padding-left: 50px;">Advance Diploma in Fire Safety</td>
                                <td>ADFS</td>
                            </tr>
                            <tr>
                                <td>2</td>
                                <td style="text-align: left; padding-left: 50px;">Advance Diploma in Fashion Design</td>
                                <td>ADFD</td>
                            </tr>
                        </tbody>
                    </table>
