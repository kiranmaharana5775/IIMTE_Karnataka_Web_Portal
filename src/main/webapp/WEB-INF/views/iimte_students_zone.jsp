...
<html>
	<head>
        ...
        <link rel="stylesheet" href="./css/iimte_students_zone_styles.css">
            ...
            <nav class="navbar">
                <div class="nav-container">
                    ...
                    <ul class="nav-menu">
                        ...
                        <li><a href="students_zone" style="background-color: rgb(51, 51, 122); color: white; border-radius: 5px;">Students Zone</a></li>
